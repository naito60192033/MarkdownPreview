...
function cacheEls() {
  els = {
    ...
    settingAlertTitleLink: document.getElementById('settingAlertTitleLink'),
    settingAlertTitleMemo: document.getElementById('settingAlertTitleMemo'),
    settingAlertTitleCheck: document.getElementById('settingAlertTitleCheck'),
    settingAlertTitleQuestion: document.getElementById('settingAlertTitleQuestion'),
    resetAlertTitleNote: document.getElementById('resetAlertTitleNote'),
    resetAlertTitleTip: document.getElementById('resetAlertTitleTip'),
    resetAlertTitleImportant: document.getElementById('resetAlertTitleImportant'),
    resetAlertTitleWarning: document.getElementById('resetAlertTitleWarning'),
    resetAlertTitleCaution: document.getElementById('resetAlertTitleCaution'),
    resetAlertTitleLink: document.getElementById('resetAlertTitleLink'),
    resetAlertTitleMemo: document.getElementById('resetAlertTitleMemo'),
    resetAlertTitleCheck: document.getElementById('resetAlertTitleCheck'),
    resetAlertTitleQuestion: document.getElementById('resetAlertTitleQuestion'),
...
async function setup() {
  ...
  settingsPanel = createSettingsPanel({
    ...
    alertTitleInputs: {
      ...
      link: els.settingAlertTitleLink,
      memo: els.settingAlertTitleMemo,
      check: els.settingAlertTitleCheck,
      question: els.settingAlertTitleQuestion,
    },
    alertTitleResetButtons: {
      note: els.resetAlertTitleNote,
      tip: els.resetAlertTitleTip,
      important: els.resetAlertTitleImportant,
      warning: els.resetAlertTitleWarning,
      caution: els.resetAlertTitleCaution,
      link: els.resetAlertTitleLink,
      memo: els.resetAlertTitleMemo,
      check: els.resetAlertTitleCheck,
